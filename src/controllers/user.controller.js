  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user[0].watchHistory,
        "watch hitory fetched succesfully",
      ),
    );
});
//***imp
//  */ while we selecting _id it gives us a string which is not a mongodb actual complete id  as we use mongoose  it adds the string to  objectid("") but the actual id in mongoDB includes objectid("") also.
